                    ...
                    <div className='flex flex-col lg:flex-row justify-between items-center gap-4 lg:gap-12'>
                        ...
                        <div className='lg:w-6/12  w-full w-12/12'>
                            <div className='border-l-[8px] lg:border-l-[14px] rounded-tl-lg rounded-bl-lg border-[#F7C35F] ps-4'>
                                <h2 className='text-3xl md:leading-[1.3] md:text-4xl lg:text-[40px] font-semibold redhat text-black mt-4 mb-6'>{heading}</h2>
                                <h3 className='text-xl md:leading-[1.3] md:text-[26px]  font-semibold redhat text-[#2D6B5E] mb-6'>{subtitle}</h3>
            ...
            <section className='relative text-center md:text-left   pb-16   lg:pb-24'>
                <div className='mx-auto max-w-7xl px-4 md:px-6 lg:px-2 relative z-1 '>
                    <div className='flex md:flex-col lg:flex-row justify-between items-center gap-4 lg:gap-12 flex-col-reverse'>
                        <div className='lg:w-6/12  w-full  w-12/12'>
                            <h2 className='text-3xl md:leading-[1.3] md:text-4xl lg:text-[40px] font-semibold redhat text-black mt-4 mb-6'>{heading}</h2>
                            <p className='text-black text-base md:text-[17px] redhat text-justify mb-10' dangerouslySetInnerHTML={{ __html: description }}>
                            </p>
                        ...
                        {vision.map((item, index) => (
                            ...
                            <div key={index} className='lg:w-6/12  w-full  w-12/12'>
                                <div className='flex flex-col md:flex-row gap-10'>
                                    ...
                                    <div>
                                        <h3 className='text-xl md:leading-[1.3] md:text-2xl lg:text-[28px] font-semibold redhat text-black mb-4'>{item.title}</h3>
                                        <p className='text-[#141414] text-justify opacity-75 text-base md:text-[17px] redhat mb-6' dangerouslySetInnerHTML={{ __html: item.description }}>
                                        </p>
                                    </div>
                                </div>
                            </div>
