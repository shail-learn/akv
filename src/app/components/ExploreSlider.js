      ...
      <div className="relative z-10 mx-auto max-w-[1400px] px-6 md:px-8 lg:px-2">
        {(heading || subheading) && (
          <div className="text-center text-white mb-10">
            {heading && (
              <h2 className="text-3xl md:text-4xl font-medium redhat mb-4">
                {heading}
              </h2>
            )}
            {subheading && (
              <p className="text-base md:text-lg">{subheading}</p>
            )}
          </div>
        )}
              ...
              <SwiperSlide key={index}>
                <div className="bg-white w-[90%] mx-auto bg-opacity-20 backdrop-blur text-white rounded-xl overflow-hidden h-full">
                  ...
                  <div className="p-6">
                    ...
                    {item.description && (
                      <p
                        className="text-sm lg:text-base redhat"
                    ...
                    {item.link && (
                      <div className="my-6 pt-4 text-center">
                        <Link href={item.link}>
                          <span className="inline-block border border-white text-white text-sm px-6 py-3 hover:bg-gray-800 transition">
                            Learn More
                          </span>
                        </Link>
                      </div>
