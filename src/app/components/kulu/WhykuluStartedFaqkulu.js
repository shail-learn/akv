...
export const Whykulu = () => {
    ...
    const title1 =
      "At Atulye Krishi Vana, we specialize in:";
    const title2 = "";

    const card = [
      {
        title:
          "High-yield Kulu plantations using scientific farming techniques.",
      },
      {
        title:
...
export const Started = () => {
    ...
    return (
      <section className="relative bg-no-repeat py-14 lg:py-32 bg-cover w-full" style={{backgroundImage: `url(${PartnerBg.src})`}}>
        ...
        <div className="relative z-10 h-full flex  px-4 md:px-20 max-w-5xl">
          <div className="max-w-7xl text-white text-left pl-3 md:pl-[4rem] mt-5">
            ...
            <p className="mb-4 text-sm md:text-base md:w-2/3 w-full" dangerouslySetInnerHTML={{__html: description}}>
