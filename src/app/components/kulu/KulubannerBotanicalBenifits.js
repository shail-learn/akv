...
export const Kulubanner = () => {
  const text = {
    ...
    title:
      "Kulu (Sterculia urens) is a deciduous tree native to India, known for its high-value gum extraction. It thrives in dry deciduous forests and rocky terrains, making it a resilient species with multiple commercial and ecological benefits. ",
    opacity: "opacity-50",
  };
  return (
    <>
...
export const Botanical = () => {
  ...
  return (
    <>
      ...
      <Iconslider card={cardData} heading={heading} />
    </>
  );
};
