  ...
  return (
    <>
      <div
        ...
        <div className={`absolute h-full top-0 bottom-0 w-full bg-black opacity-20 ${opacity}`}></div>
        <div className="relative text-center z-1 flex flex-wrap w-full items-center justify-center">
          <div className='w-11/12 md:w-3/4 lg:w-7/12'>
            ...
            <h1 className="text-white text-3xl md:text-4xl lg:leading-tight lg:text-[40px] font-normal w-full" dangerouslySetInnerHTML={{ __html: heading }}></h1>
            <p
