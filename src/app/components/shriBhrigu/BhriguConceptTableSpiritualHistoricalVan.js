...
export const Concept = () => {
    const basketData = {
        note: `
        Theme Index: Navagrah <br/>
        Location Name: Shri. Bhrigu Van <br/>
        Coordinates: 22°59'40.3"N 77°10'47.2"E <br/>
        Area: 3135 square meters <br/>
        Date of Planting: 14 November 2021 <br/>
        Distance from Admin Block: 670 meters
        `,
        image: info,
    };
