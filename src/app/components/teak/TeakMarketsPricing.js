...
export const Teak = () => {
    const text = {
        ...
        title: "Teak (Tectona grandis) is a high-value hardwood known for its strength, durability, and natural resistance to pests and decay. Indigenous to India, teak has been used for centuries in furniture, boatbuilding, and construction. ",
        opacity: 'opacity-50'
    }
    return (
        <>
    ...
    const cardData = [
        {
            ...
            description: "Preferred for garden furniture and decking as it withstands harsh weather.",
        },
        {
            title: "Luxury furniture",

            description: "Teak’s aesthetic appeal and durability make it a premium choice.",
        },
        {
            title: "Marine industry",

            description: "Used in yacht decks and boat construction due to its water-resistant properties.",
        },
        {
        ...
        <>
            ...
            <div className='bg-[#1B453C] py-6'>
                <div className='max-w-7xl mx-auto px-4 text-center text-white text-base'>
                    <p>The demand for teak has surged, particularly in India, China, Europe, and the Middle East, where premium <br /> <b> wood products are in high demand.</b>
                    </p>
                </div>
            </div>
        ...
        points: [
            {
                ...
                description:
                    "Found in India, Myanmar, Thailand, and Laos.",
            },
            {
        ...
        <section className="relative z-20 bg-[#1b453c] text-white pb-4 md:pb-20">
            ...
            <div className='bg-[#1B453C] pt-8 md:pt-14'>
                <div className='max-w-5xl mx-auto px-4 text-center text-white text-base'>
                    <p>However, due to deforestation regulations and sustainability concerns, natural teak supplies have declined, increasing reliance on plantations.
