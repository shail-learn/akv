...
import banner from "../../../assets/images/business/bg-about.webp";
...
export const About = () => {
  ...
  return (
    ...
    <section
    className="bg-cover bg-bottom relative  pt-0 pb-44 lg:py-0 lg:pb-[22rem]   flex items-center justify-center"
    style={{ backgroundImage: `url(${banner.src})` }}
>

    <div className="relative text-center z-1 flex flex-wrap items-center justify-center">
        <div className='w-11/12 md:w-7/4 lg:w-5/12   bg-[#1B453C] bg-opacity-60  p-6 rounded-3xl'>
            <h2 className="text-white text-2xl md:text-4xl lg:leading-tight redhat  font-medium w-full">  {text.heading}</h2>

            <p className='w-full text-white text-sm lg:text-[15px] mt-4'>
                {text.title}
            </p>
