...
export const About = () => {
    const aboutData = {
        heading: 'About Us',
        description:
          'MIDH Nursery is a pioneering initiative blending modern agricultural practices with traditional agroforestry wisdom. We specialize in cultivating high-quality plant species that contribute to environmental sustainability, economic growth, and food security.',
        cards: [
          {
            icon: icon1,
            title: 'Mission',
...
export const Key = () => {
  const heading = "Key Sections of MIDH Nursery"
