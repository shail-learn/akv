      ...
      <section className="w-full bg-[#1B453C] pt-16 pb-10 relative">
        <div className="mx-auto max-w-7xl px-4 md:px-8 lg:px-2 relative z-10">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start gap-10 mb-14">
            ...
            <p className="text-white redhat text-base md:text-[17px] max-w-3xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 md:gap-12">
              {growthData.items.map((item, index) => (
                ...
                >
                  ...
                  <p className="text-base md:text-[17px] mt-10 text-black ">
                    {item.text}
                  </p>
                </div>
              ))}
        ...
        <div className="flex flex-wrap lg:flex-nowrap gap-6 md:gap-16 justify-between items-end">
          ...
          <div className="w-full lg:w-6/12">
            <div className="flex flex-col h-full justify-between">
              <h2 className="text-white text-3xl md:text-4xl lg:text-[40px] font-semibold md:leading-snug redhat mb-4 lg:mb-7 text-center lg:text-left" dangerouslySetInnerHTML={{ __html: visitInfoData.heading }} />
              ...
              <ul className="space-y-4">
                {visitInfoData.info.map((item, index) => {
                  ...
                  return (
                    ...
                    >
                      <Icon className="text-[#F7C35F] mt-1 min-w-8" size={22} />
                      <p className="redhat">
