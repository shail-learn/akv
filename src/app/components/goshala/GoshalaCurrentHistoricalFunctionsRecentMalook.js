...
export const Current = () => {
    const basketData = {
        note: `
        Theme Index: Gaushala <br/>
        Location Name: Shri. Malook Pithadhishwar Swami Shri Rajendra Das ji Maharaj Gaushala <br/>
        Coordinates: 22°59'41.1"N 77°10'56.0"E <br/>
        Area: 500 sq m <br/>
        Distance from Admin Block: 410 meters
        `,
        image: info,
    };
    ...
    const GrowthDescription = "The Gaushala currently shelters:"
    const slides = [
        {
            image: image1,
            title: "3 desi Gomata (Indian cows)",
        },
        {
            image: image1,
            title: "1 Nandi (bull)",
    ...
    const GrowthDescription1 = "There are future plans to expand the shelter to house up to 50 desi cows of native Indian breeds, promoting preservation and responsible cattle rearing."
...
export const Functions = () => {
    const heading = "Functions and Benefits"
    ...
    const boxslider = [
        {
          ...
          description: [
            ...
            "Promotes a healthy environment for aging and young cattle alike"
          ]
        },
        {
          image: impact1,
        ...
        {
          image: impact1,
          heading: "Organic Farming Support",
          description: [
            "Produces natural manure from cow dung, used in the fields of Atulye Krishi Vana",
            "Enhances soil fertility and promotes chemical-free farming"
          ]
        },
        {
          image: impact1,
          heading: "Sustainability and Resource Recycling",
          description: [
            "Integrates livestock into farming cycles for nutrient cycling and reduced waste",
            "Encourages closed-loop systems where nothing goes unused"
          ]
        },
        {
          image: impact1,
          heading: "Educational and Cultural Value",
          description: [
            ...
            "Reinforces cultural respect for animals and farming heritage"
          ]
        },
        {
            image: impact1,
