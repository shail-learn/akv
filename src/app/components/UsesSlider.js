...
export const UsesSlider = ({ card, heading, classname, title1, title2 }) => {
    return (
        <>

            <section className={`overflow-hidden ${classname || ''}`}>
                <section className="py-14 lg:py-16 pt-16 lg:pb-24 relative bg-[#F5F5F5]">
                    ...
                    <div className="mx-auto max-full max-w-7xl px-4 md:px-6 lg:px-2 relative">
                        <div className="w-full text-center">
                            <h2 className="text-[#1B453C] text-3xl md:text-4xl mb-16 lg:leading-tight redhat font-medium w-full">
                                {heading}
                            </h2>
                                            ...
                                            <SwiperSlide key={index}>
                                                ...
                                                >
                                                    <div className="grid items-center md:text-left justify-center gap-6">
                                                        <h3 className="text-base md:text-lg text-[#1B453C]">
                                                            {item.title}
                                                        </h3>
                                                        <ul className="list-disc ml-4 text-[15px] font-light">
                        ...
                        <div>
                            <Image
                                src={icon1}
                                alt="Banner Tree"
                                className="lg:w-60 w-32 h-auto object-contain -bottom-16 lg:-bottom-28 absolute lg:-left-24 left-0 z-10"
                            />
                            <Image
                                src={icon2}
                                alt="Banner Tree"
