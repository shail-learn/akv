...
export const Grass = () => {
    const text = {
        ...
        title: 'Grasses and leguminous fodder crops are the lifelines of rural ecosystems. They serve not only as vital feed for livestock but also as tools for soil health improvement, erosion control, and agroecological resilience. ',
        opacity: 'opacity-50'
    }
    return (
        <>
...
export const Hathi = () => {
    ...
    const shortinfo = "<b>The Giant Grass for Giant Needs</b> <br/> Popularly known as Elephant Grass, Hathi Ghas is a perennial, tall-growing grass valued for its enormous green fodder yield. It is ideal for cattle, buffaloes, and even goats when chopped and mixed."
    ...
    const whyChooseData = [

        {
            ...
            description: "Produces up to 300–400 tonnes per hectare annually under optimal conditions."
...
export const Lucerne = () => {
    ...
    const whyChooseData = [
      ...
      },
      {
        ...
        description:"Fixes atmospheric nitrogen, improving soil health for subsequent crops."
...
export const Atulye = () => {
    ...
    const title= "We help farmers, dairy cooperatives, fodder banks, and community institutions adopt best practices in fodder cultivation. "
    ...
    const card = [
      {
        ...
        description: "Supply of rooted slips (Hathi Ghas) and certified Lucerne seeds."
      },
      {
      ...
      },
      {
        ...
        description: "Guidance for fodder-tree interplanting and boundary cropping."
      },
      {
        title: "Nursery Setup",
      ...
      {
        title: "Linkages",
        description: "Connect to veterinary extension services, milk federations, and local composting initiatives."
      },
