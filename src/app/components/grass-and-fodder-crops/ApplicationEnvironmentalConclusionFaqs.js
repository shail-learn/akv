...
import Plant from "../../../assets/images/grass/future.webp";
      ...
      <section className="text-center md:text-left  pb-16 pt-16 lg:pb-20 lg:pt-20">
        <div className="mx-auto max-w-7xl  px-6 flex flex-col-reverse md:flex-row items-center gap-10 lg:gap-20">
          <div className="w-full md:w-1/2 text-center md:text-left">
            <h2
              className="text-3xl md:leading-[1.3] md:text-4xl font-semibold redhat text-black mb-4 md:mb-20"
...
export const Faqs = () => {
  ...
  const FaqsData = [
    {
      question:
        "What are the initial setup requirements for planting Hathi Ghas on 1 acre?",
      answer:
    ...
    {
      question: "Can Lucerne be grown in rainfed areas without irrigation?",
      answer:
    ...
    {
      question:
        "Are there any pest or disease challenges in Hathi Ghas or Lucerne cultivation?",
      answer:
