  ...
  return (
    <>
      <header className='sticky top-0 z-[99]'>
        <Disclosure as="nav" className="bg-teal-900 pt-2 pb-2">
            ...
            <div className="relative flex  items-center justify-between">
                    ...
                    {navigation.map((item) => (
                      <Link
                        ...
                        className={classNames(
                          item.current ? ' text-white' : 'text-neutral-400 hover:text-white',
              ...
              <div className="inset-y-0 left-0 flex items-center md:hidden">
                ...
                <DisclosureButton className="group relative inline-flex items-center justify-center rounded-md p-2 text-gray-400  hover:text-white focus:outline-none">
                  ...
                  <FaBars aria-hidden="true" className="text-white block size-6 group-data-[open]:hidden" />
                  <IoCloseSharp aria-hidden="true" className="text-white hidden size-6 group-data-[open]:block" />
                </DisclosureButton>
              </div>
            </div>
          </div>
