        ...
        <>
            <section
                ...
                <div className='mx-auto max-w-7xl px-4 md:px-6 lg:px-2 '>
                    <h2 className="lg:leading-snug text-black redhat mb-8 text-center text-3xl md:text-4xl lg:text-[40px] font-semibold w-full">
                        {heading}</h2>
                                            ...
                                            <SwiperSlide key={index}>
                                                <div className='w-[100%] grid items-start md:w-full h-96 lg:h-[450px] text-center px-6 lg:px-12 py-8 bg-[#fffafaca] bg-opacity-90 rounded-[20px]'>
                                                    <div className='lg:w-12/12 mx-auto'>
                                                        ...
                                                        <p className='text-base md:text-[17px] text-black md:text-left font-normal'>{item.description}</p>
                                                    </div>
                                                </div>
                                            </SwiperSlide>
                                        ))}
